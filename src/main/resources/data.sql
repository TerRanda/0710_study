...
insert into article (`title`, `content`, `author`) values ('오늘 점심 뭐 먹나요?','점심메뉴정해주세요', '티이워언');
insert into article (`title`, `content`, `author`) values ('시험취소된기념으로 놀러감요?','뭐하고 놀지 정합시다', '티이워언');
insert into article (`title`, `content`, `author`) values ('타임리프','세상엔왜이렇게다양한언어가있는걸까', '티이워언');
insert into article (`title`, `content`, `author`) values ('금요일 일요일','2번째 경기!', '티이워언');
insert into article (`title`, `content`, `author`) values ('망햇어요','기사시험 내년에나 있어요 올해 끝났음! 망....ㅠ', '티이워언');
