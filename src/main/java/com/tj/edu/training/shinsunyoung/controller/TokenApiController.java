...
//    @PostMapping("/api/token")
//    public ResponseEntity<CreateAccessTokenResponseByRefreshToken> createAccessTokenResponseByRefreshTokenResponseEntity(
//            @RequestBody CreateAccessTokenRequestByRefreshToken createAccessTokenRequestByRefreshToken
//    ) {
//        String newToken = tokenService.createNewAccessToken(createAccessTokenRequestByRefreshToken.getRefreshToken());
//
//        return ResponseEntity.status(HttpStatus.CREATED)
//                .body(new CreateAccessTokenResponseByRefreshToken(newToken));
//    }
}
